...
```bash
./build/build-macos-clang.bash none public
```

Once executed, you will see the **innovusion-build-working-dir**  in your user directory,
The **source** directory contains the compilation intermediate process files, executable files and link libraries, as well as **inno_lidar_sdk_public.tgz**, which is a clean compressed package that can be moved at will.
